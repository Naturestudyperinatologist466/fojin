...
聚合 504 个数据源（覆盖 30 个国家/地区）、9,200+ 条目录记录（巴利、汉传、藏传、梵文四大语系，其中 7,600+ 条含全文内容）、237,593 条辞典词条、30 语种。支持 8 种界面语言（中/英/日/韩/泰/越/僧伽罗/缅甸）。内置 AI 佛学助手「小津」（基于 Dify + RAG），覆盖 38 部核心佛经约 1,100 万字知识库。
